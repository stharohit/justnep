<template>
  <div class="container my-4">
    ...
    <div class="food-items">
      <div
        class="food-item"
        v-for="(element,index) in computedObj"
        :key="index"
      ...
      <div class="food-item show-more" @click=" limited(); ">
        <span class="food-item-name">
          <i :class="{'icofont-plus-circle':limit,'icofont-minus-circle':!limit,}"></i>
...
export default {
  ...
  methods: {
    ...
    toggle(element) {
      element.active = !element.active;
        // this.cursinename.splice(this.cursinename.indexOf(element), 1);
     
    },
    get(element) {
      if(element.active){
        this.cursinename.push(element);
      }
  ...
  computed: {
    ...
    //     resturant => resturant.cursineName !== resturant.cursineName
    //   )
    // },
    filterList() {
      if(this.cursinename.length > 0){
       return this.cursinename.filter(
        resturant => !this.resturantsdata.includes(resturant.cursineName)
      );
      }
      else{
        return this.resturantsdata.slice(0, 6);
      }
