<template>
  <div id="app">
    <div id="nav" class="d-flex justify-content-between">
      ...
      <div class="nav-link">
        <router-link to="/about" class="btn-orange">Login</router-link>
        <router-link to="/about" class="btn-orange">
          <!-- <span class="rider" data-toggle="tooltip" data-placement="left" title="Become a Rider">
